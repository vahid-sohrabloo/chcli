// Package uitheme holds the chcli color theme so every UI package can
// import it without creating a cycle with internal/tui.
package uitheme
...
// Themes is the registry of named themes.
var Themes = map[string]UITheme{
	"tokyo-night": {
		...
		AccentBlue: "#7aa2f7", AccentGreen: "#9ece6a", AccentYellow: "#e0af68", AccentOrange: "#ff9e64", AccentRed: "#f7768e", AccentMagenta: "#bb9af7", AccentCyan: "#7dcfff",
	...
	"dracula": {
		...
		AccentBlue: "#8be9fd", AccentGreen: "#50fa7b", AccentYellow: "#f1fa8c", AccentOrange: "#ffb86c", AccentRed: "#ff5555", AccentMagenta: "#ff79c6", AccentCyan: "#8be9fd",
	...
	"nord": {
		...
		AccentBlue: "#88c0d0", AccentGreen: "#a3be8c", AccentYellow: "#ebcb8b", AccentOrange: "#d08770", AccentRed: "#bf616a", AccentMagenta: "#b48ead", AccentCyan: "#8fbcbb",
	...
	"gruvbox": {
		...
		AccentBlue: "#83a598", AccentGreen: "#b8bb26", AccentYellow: "#fabd2f", AccentOrange: "#fe8019", AccentRed: "#fb4934", AccentMagenta: "#d3869b", AccentCyan: "#8ec07c",
	...
	"catppuccin": {
		...
		AccentBlue: "#89b4fa", AccentGreen: "#a6e3a1", AccentYellow: "#f9e2af", AccentOrange: "#fab387", AccentRed: "#f38ba8", AccentMagenta: "#f5c2e7", AccentCyan: "#94e2d5",
	...
	"solarized": {
		...
		AccentBlue: "#268bd2", AccentGreen: "#859900", AccentYellow: "#b58900", AccentOrange: "#cb4b16", AccentRed: "#dc322f", AccentMagenta: "#d33682", AccentCyan: "#2aa198",
		Border: "#586e75", SyntaxTheme: "solarized-dark",
	},
}

// Active is the current UI theme.
var Active = Themes["tokyo-night"]

// Set changes the active UI theme by name. Returns false if not found.
